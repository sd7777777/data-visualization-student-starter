...
import { CategorySharePlot, ConcentrationCurve, CostProviderBalance, DistributionHistogram, FieldMissingnessPlot, SpecialtyComposition, SpecialtyFingerprint, SpecialtyRanking, SpecialtyScatter, StateComparison, StateTileMap, type ConcentrationMetric, type Metric, type RankMetric } from './analysis-charts';
...
export default function PartDFieldNotes() {
  ...
  return <main>
    ...
    <nav className="section-directory" aria-label="Explorer sections"><span>jump to:</span><a href="#relationship">01 relationship</a><a href="#scale">02 scale</a><a href="#composition">03 composition</a><a href="#mix">04 clinical mix</a><a href="#place">05 geography</a><a href="#records">06 records</a><a href="#data">07 data quality</a></nav>
    ...
    <section id="composition" className="section-wrap">
      <div className="story-question"><b>03 / composition</b><h2>Which specialties account for a disproportionate share of cost?</h2><p>These views compare specialty drug cost with provider-record counts.</p></div>
    ...
    <section id="mix" className="section-wrap mix-section">
      <div className="story-question"><b>04 / clinical mix</b><h2>How does the selected specialty differ from the field?</h2><p>Category shares and percentiles are descriptive; they are not quality measures.</p></div>
    ...
    <section id="place" className="section-wrap story-section">
      <div className="story-question"><b>05 / geography</b><h2>Where do state-level values differ?</h2><p>Choose a specialty and measure. Higher means more of the selected measure, not better care.</p></div>
    ...
    <section id="records" className="section-wrap provider-section">
      <div className="story-question"><b>06 / provider records</b><h2>Which records have the largest drug-cost totals?</h2><p>{area.name}. Descriptive, not a performance ranking.</p></div>
    ...
    <section id="data" className="section-wrap data-section">
      <div className="story-question"><b>07 / data quality</b><h2>What does the source file look like?</h2><p>{data.meta.rows.toLocaleString()} rows · {data.meta.columns} fields · full file, not a sample.</p></div>
      ...
      <div className="small-multiples"><DistributionHistogram data={data} active={distribution}/><FieldMissingnessPlot data={data}/></div>
    </section>
