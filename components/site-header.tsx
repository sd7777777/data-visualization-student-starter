export function SiteHeader(_props: { section?: 'explorer' | 'lab' | 'coursework'; base?: '.' | '..' } = {}) {
  return <header className="site-header" id="week-1">
    ...
    <nav aria-label="Primary navigation">
      <a href="#week-3">charts</a><a href="#place">states</a><a href="#data">data</a><a href="#task-analysis">tasks</a><a href="./downloads/part-d-prescriber-source.zip" download>download</a>
