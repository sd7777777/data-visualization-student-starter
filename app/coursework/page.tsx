...
const assignments = [
  ...
  { week: 'PROJECT', title: 'Final Project Exploration 1', status: 'In progress', items: ['Domain, audience, questions, data source, and limitations are documented.', 'Multiple visual directions now exist: scatter, lollipop comparison, histogram, and record table.', 'Related CMS documentation is linked from the repository and site.', 'Hand-drawn sketch photographs remain a student-authored deliverable.'] },
